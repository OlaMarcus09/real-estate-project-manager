...
export default function Dashboard() {
  ...
  const totalSpent = projects?.reduce((sum, project) => sum + (project.spent || 0), 0) || 0;

  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Project Overview</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-green-50 p-4 rounded-lg border border-green-200">
          ...
          <p className="text-sm text-green-700">
            Add workers and vendors to track your team and suppliers.
          </p>
        </div>
        ...
        <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
          ...
          <p className="text-sm text-orange-700">
            Inventory management features are in development.
          </p>
        </div>
      </div>
    </div>
